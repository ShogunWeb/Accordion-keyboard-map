...
const translations = {
  en: {
    ...
    download: "Download PDF", exporting: "Preparing PDF…", pdfHint: "A4 · 2 full keyboards per page",
  ...
  fr: {
    ...
    download: "Télécharger le PDF", exporting: "Préparation du PDF…", pdfHint: "A4 · 2 claviers complets par page",
